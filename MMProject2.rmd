...
print('A Summary of the NonPopular 2000\'s Tracks:')
summary(subset(data2000, target == 0))

print('A Summary of the Popular 1960\'s Tracks:')
summary(subset(data1960, target == 1))

print('A Summary of the NonPopular 1960\'s Tracks:')
summary(subset(data1960, target == 0))
```
